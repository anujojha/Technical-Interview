package SemaphoreMutexTutorial;
...
class SemaphoreMutex2 {
    ...
    private static final int MAXCONCURRENTTHREADS = 2;
    private final Semaphore crunchifyAdminLOCK = new Semaphore(MAXCONCURRENTTHREADS, true);
