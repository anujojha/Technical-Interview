...
public class Simulation {
    ...
    public static final double MEANINTERARRIVALTIME = 8;
    public static final double MEANSERVICETIME = 32;

    public static int sCustomers = CUSTOMERS;
    ...
    public static void main(String[] args) {
        ...
        try {
            sCustomers = Integer.parseInt( args[0]);
        } catch( Exception e) {}
    ...
    public static double simulate(Queue queue) throws InterruptedException {
        ...
        for (int i = 0; i < SERVERS; i++) {
            ServerThread server = new ServerThread(queue, MEANSERVICETIME);
            servers[i] = server;
        ...
        // exponentialSleep(MEANINTERARRIVALTIME);
        // between starting each customer.
        /**********************************************/
        //Create customer threads

        CustomerThread[] customers = new CustomerThread[sCustomers];
        for( int i = 0; i < sCustomers; i++) {
        ...
        return totalWaitTime / sCustomers;
    }
